...
public final class Constants {
    ...
    public static final Vector2 E_SIZE = new Vector2(32,32);
    public static final float C_SPEED = 100;
    public static final float B_SPEED = 3*C_SPEED;
    public static final float E_SPEED = 1.2f*C_SPEED;
